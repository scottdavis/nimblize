...
class GeneratorTest extends PHPUnit_Framework_TestCase {
	 ...
	 */
	function testGenerateScriptsNotADir() {
	  Generator::generate_scripts(vfsStream::url('root/blah'));
	}
  ...
  function testHelp() {
		file_put_contents(vfsStream::url('root/template/help.tmpl'), "help");

		$this->assertEquals('help', Generator::help());
